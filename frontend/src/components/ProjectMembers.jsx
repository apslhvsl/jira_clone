...
function ProjectMembers() {
  ...
  const fetchJoinRequests = async () => {
    ...
    try {
      const res = await fetch(
        `https://jira-clone-mtig.onrender.com/projects/${selectedProject.id}/join-requests`,
        {
  ...
  const handleRequestAction = async (requestId, action) => {
    ...
    try {
      const res = await fetch(
        `https://jira-clone-mtig.onrender.com/projects/${selectedProject.id}/join-request/${requestId}/${action}`,
        {
          method: "POST",
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleRemove = async (userId) => {
    ...
    try {
      const res = await fetch(
        `https://jira-clone-mtig.onrender.com/projects/${selectedProject.id}/members/${userId}`,
        {
          method: "DELETE",
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const canModifyMembers =
    myProjectRole === "admin" || myProjectRole === "manager";
