...
function Board() {
  ...
  if (!myProjectRole) {
    return (
      <div style={{ padding: 32, color: "#faad14", fontWeight: 500 }}>
            ...
            return (
              <Col key={col.key} xs={24} sm={12} md={6}>
                ...
                >
                  ...
                  <SortableContext
                    items={displayTasks[col.key].map((t) => t.id)}
                        ...
                        >
                          ...
                          >
                            <Button
                              ...
                              size="small"
                              onClick={() =>
                                canEditOrMove(task) && handleDelete(task.id)
                              }
