    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const statsRes = await fetch(
          "https://jira-clone-mtig.onrender.com/dashboard/stats",
          {
        ...
        const activityRes = await fetch(
          "https://jira-clone-mtig.onrender.com/items/activity",
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
        ...
        // Fetch my tasks
        const myTasksRes = await fetch(
          "https://jira-clone-mtig.onrender.com/items/my-tasks",
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
        ...
        const projectsRes = await fetch(
          "https://jira-clone-mtig.onrender.com/projects",
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
        ...
        if (selectedProject) {
          const progressRes = await fetch(
            `https://jira-clone-mtig.onrender.com/projects/${selectedProject.id}/progress`,
            {
              headers: { Authorization: `Bearer ${token}` },
            }
          );
  ...
  useEffect(() => {
    ...
    const fetchForProject = async () => {
      ...
      const colRes = await fetch(
        `https://jira-clone-mtig.onrender.com/projects/${selectedTaskProject}/columns`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
      ...
      const userRes = await fetch(
        `https://jira-clone-mtig.onrender.com/projects/${selectedTaskProject}/members`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
      ...
      const epicsRes = await fetch(
        `https://jira-clone-mtig.onrender.com/items/projects/${selectedTaskProject}/items`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
                ...
                <List.Item>
                  ...
                  <span
                    style={{
                      ...
                      borderRadius: 4,
                      background:
                        task.status === "done" ? "#f6ffed" : "#f0f0f0",
                      color: task.status === "done" ? "#52c41a" : "#888",
                      fontWeight: 500,
                      fontSize: 12,
                    }}
                  >
            ...
            <List
              ...
              renderItem={(log) => (
                <List.Item>
                  ...
                  {log.action}{" "}
                  <span style={{ color: "#888" }}>{log.details}</span>{" "}
